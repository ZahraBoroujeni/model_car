...
if("TRUE" STREQUAL "TRUE")
  set(async_web_server_cpp_SOURCE_PREFIX /root/catkin_ws/src/async_web_server_cpp)
  set(async_web_server_cpp_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(async_web_server_cpp_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/src/async_web_server_cpp/include;/usr/include " STREQUAL " ")
  set(async_web_server_cpp_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/src/async_web_server_cpp/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'async_web_server_cpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/async_web_server_cpp/${idir}'.  Ask the maintainer 'Russell Toris <russell.toris@gmail.com>' to fix it.")
    endif()
    _list_append_unique(async_web_server_cpp_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "async_web_server_cpp;/usr/lib/arm-linux-gnueabihf/libboost_thread.so;/usr/lib/arm-linux-gnueabihf/libboost_system.so;/usr/lib/arm-linux-gnueabihf/libboost_regex.so;/usr/lib/arm-linux-gnueabihf/libboost_filesystem.so;/usr/lib/arm-linux-gnueabihf/libpthread.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/lib;/root/catkin_ws/devel/lib;/root/catkin_ws/odroid-devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${async_web_server_cpp_dep}_FOUND)
      find_package(${async_web_server_cpp_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${async_web_server_cpp_dep} REQUIRED ${depend_list})
  endif()
